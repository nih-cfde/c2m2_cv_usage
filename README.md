...
Problem: remove_zeros.py gets rid off all columns. `table_40_lines.csv` is the first 40 lines of the `table.csv` output file generated by `display.py`, which is the input for `remove_zeros.py`
